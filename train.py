...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[10_000, 20_000, 30_000, 50_000, 100_000, 300_000])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[10_000, 20_000, 30_000, 50_000, 100_000, 300_000])
    parser.add_argument("--quiet", action="store_true")
    parser.add_argument("--panorama", action="store_true")
    parser.add_argument("--simple_mask", nargs="+", type=float, default=None)
    parser.add_argument("--checkpoint_iterations", nargs="+", type=int, default=[10_000, 20_000, 30_000, 50_000, 100_000, 300_000])
